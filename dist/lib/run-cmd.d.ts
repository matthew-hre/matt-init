...
export declare function runCmd(cmd: string, args: string[], opts?: Options): Promise<import("execa").Result<{
    preferLocal?: boolean;
    localDir?: string | URL;
    node?: boolean;
    ...
    stdio: "pipe" | "inherit" | "ignore" | "overlapped" | readonly [import("execa/types/stdio/type").StdinOptionCommon<false, false>, import("execa/types/stdio/type").StdoutStderrOptionCommon<false, false>, import("execa/types/stdio/type").StdoutStderrOptionCommon<false, false>, ...import("execa/types/stdio/type").StdioExtraOptionCommon<false>[]];
    all?: boolean;
...
//# sourceMappingURL=run-cmd.d.ts.map