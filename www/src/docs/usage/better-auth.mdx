...
Better Auth is a modern authentication library that provides type-safe authentication for TypeScript applications. When you choose the backend option, matt-init sets up Better Auth with email/password authentication and session management.
