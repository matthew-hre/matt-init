...
- **What it is:** Continuous integration setup for linting
- **Why I chose it:** Automated code quality checks, runs on every PR
- **Includes:** Linting workflow, runs on push and pull request events

## Backend Stack (All Optional)
...
### Docker + Postgres
- **What it is:** Full-featured relational database using Docker
- **Why I chose it:** Powerful, flexible, great for complex applications
- **Learn more:** [Docker + Postgres documentation](/docs/usage/databases#docker-postgres)
